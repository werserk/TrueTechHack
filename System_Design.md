...
### Интерфейс:
- [x] 1. Разработка системы управления профилем (выбор настроек)
- [x] 2. Возможность загрузки и сохранения видео
...
8. Высококонтрастный режим
9. Регулируемая скорость воспроизведения
